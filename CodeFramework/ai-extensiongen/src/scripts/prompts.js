...
export const DEFAULT_PROMPTS = {
  ...
  SELENIUM_JAVA_PAGE_ONLY: `
    ...
    3. Code structure:
       ...
       The class structure should mirror the existing framework's pattern (as in LoginPage.java):
       - Use Cucumber step definition annotations (@Given, @When, @Then,@And) as applicable.
...
public class LoginPage extends SeleniumBase {
    ...
    /**
     * Clicks the Home Sign In button on the Login Page.
     * @return LoginPage instance for method chaining.
     */
    @Given("I click the Home Sign In button")
    public LoginPage clickSignIn() {
        click(locateElement(Locators.XPATH, "//button[normalize-space(text())='SIGN IN']"));
        reportStep("Sign In button clicked on Login Page", "pass");
        return this;
    }
    ...
    public LoginPage enterUsername(String username) {
        clearAndType(locateElement(Locators.NAME, "pf.username"), username);
        reportStep("Username entered on Login Page", "pass");
        return this;
    }
     ...
     * @return LoginPage instance for method chaining.
     */
    @And("I type the password as {string}")
    public LoginPage enterPassword(String password) {
        clearAndType(locateElement(Locators.NAME, "pf.pass"), password);
        reportStep("Password entered on Login Page", "pass");
        return this;
    }
    ...
    public void clickSignInButton() {
        click(locateElement(Locators.XPATH, "//span[normalize-space(text())='Sign In']"));
        reportStep("Sign In submit button clicked on Login Page", "pass");
    }
}
  \`\`\`
  `,
